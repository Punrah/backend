		...
		<div class="col-md-12">
              ...
              <div class="box box-success">
                <div class="box-header with-border">
                  <h3 class="box-title">Data Menu Explore</h3>
                </div><!-- /.box-header -->
                  <div class="box-body">
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Add Menu Explore</h4>
      </div>
      <div class="modal-body">
      <form role="form" enctype="multipart/form-data" method="post" id="" action="modul/restaurant/action.php?aksi=add_menu_explore">
 ...
 <!-- jQuery 2.1.4 -->
	...
	var table = $("#example1").DataTable( {
        "ajax": 'modul/restaurant/ajaxData.php?cari=explore_category'
    } );
	      $('.date').datepicker({
      autoclose: true,
      format: 'yyyy/mm/dd',
